...
const CASES: CaseItem[] = [
  ...
  },
  {
    id: "food-drinks",
    emoji: "🍔",
    question: "Производство еды и напитков",
    shortAnswer: "Класс 29 (мясо, рыба, молочка) + 30 (кофе, чай, выпечка) + 32 (напитки). Для продаж — 35.",
    classes: [
      { id: 29, reason: "Мясо, рыба, молочные продукты, консервы, яйца", required: "always" },
      { id: 30, reason: "Кофе, чай, какао, хлеб, кондитерка, специи, макароны", required: "always" },
      { id: 32, reason: "Безалкогольные напитки, соки, воды, пиво", required: "always" },
      { id: 33, reason: "Алкогольные напитки (вино, крепкое)", required: "sometimes" },
      { id: 35, reason: "Розничная/онлайн продажа, реклама", required: "always" },
      { id: 39, reason: "Если есть доставка своей продукции", required: "sometimes" },
      { id: 43, reason: "Если есть кафе/дегустационный зал", required: "sometimes" },
    ],
    tip: "Класс 29 — для «живой» еды (мясо, молоко, рыба). Класс 30 — для «сухой» (кофе, чай, специи, выпечка). Класс 32 — для напитков. Если производите полный ассортимент — нужны все три.",
    warning: "Алкоголь — отдельный класс 33. Если производите пиво — это класс 32 (безалкогольные + пиво). Вино, водка, коньяк — класс 33.",
  },
  {
    id: "toys",
    emoji: "🧸",
    question: "Игрушки и детские товары",
    shortAnswer: "Класс 28 (игрушки, игры) — основной. Для одежды — 25, для безопасности — 9.",
    classes: [
      { id: 28, reason: "Игрушки, настольные игры, ёлочные украшения, рыболовные снасти", required: "always" },
      { id: 25, reason: "Детская одежда, обувь", required: "sometimes" },
      { id: 9, reason: "Электронные игрушки, гаджеты для детей", required: "sometimes" },
      { id: 16, reason: "Книги, раскраски, детские издания", required: "sometimes" },
      { id: 35, reason: "Розничная/онлайн продажа игрушек", required: "always" },
      { id: 41, reason: "Если детские развлекательные услуги, игровые комнаты", required: "sometimes" },
    ],
    tip: "Класс 28 покрывает почти все игрушки — мягкие, настольные игры, конструкторы, видеоигры. Даже ёлочные игрушки и рыболовные снасти тут.",
    warning: "Детская одежда — это класс 25 (как взрослая). Нет отдельного класса для «детского». Электронные игрушки (роботы, дроны) — класс 9.",
  },
  {
    id: "sports-goods",
    emoji: "⚽",
    question: "Спорттовары и инвентарь",
    shortAnswer: "Класс 28 (инвентарь, мячи) — основной. Для одежды — 25, для питания — 29/30.",
    classes: [
      { id: 28, reason: "Спортинвентарь, мячи, тренажёры, снаряжение", required: "always" },
      { id: 25, reason: "Спортивная одежда, обувь, форма", required: "always" },
      { id: 9, reason: "Фитнес-трекеры, электроника для спорта", required: "sometimes" },
      { id: 29, reason: "Спортивное питание (протеины, батончики)", required: "sometimes" },
      { id: 30, reason: "Спортивные напитки, энергетики", required: "sometimes" },
      { id: 35, reason: "Розничная/онлайн продажа, реклама", required: "always" },
      { id: 41, reason: "Если услуги фитнеса, тренировки, секции", required: "sometimes" },
    ],
    tip: "Сам инвентарь — класс 28. Одежда для спорта — класс 25 (не 28). Спортивное питание — класс 29. Если открываете спортшколу/клуб — добавьте класс 41.",
    warning: "«Спортивная одежда» — это класс 25, не 28. Класс 28 только для инвентаря (мячи, гантели, тренажёры). Не путайте.",
  },
  {
    id: "consulting",
    emoji: "💼",
