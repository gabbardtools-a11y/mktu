...
const CATEGORIES: Category[] = [
  {
    id: "chemistry",
    title: "Химия и материалы",
    icon: FlaskConical,
    color: "purple",
    classIds: [1, 2, 3, 4, 17],
    hint: "Химреактивы, краски, косметика, масла, резина",
  },
  {
    id: "tools",
  ...
  },
  {
    ...
    hint: "ПО, приборы, освещение, транспорт, оружие, драгоценности",
  },
  {
    id: "home",
    title: "Дом и быт",
    icon: Home,
    color: "amber",
    classIds: [15, 16, 19, 20, 21],
    hint: "Музыка, бумага, канцтовары, мебель, посуда",
  },
  {
    id: "textile",
    ...
    icon: Shirt,
    color: "gold",
    classIds: [22, 23, 24, 25, 26, 27],
    hint: "Веревки, нити, ткани, одежда, галантерея, кровати",
  },
  {
    id: "sport",
    title: "Спорт и игры",
    ...
    color: "green",
    classIds: [28],
    hint: "Игрушки, спортинвентарь, игры",
  },
  {
    id: "food",
    title: "Еда и напитки",
  ...
  },
  {
    ...
    color: "blue",
    classIds: [35, 36],
    hint: "Реклама/торговля, финансы/страхование",
  },
  {
    id: "construction",
    ...
    color: "gold",
    classIds: [37],
    hint: "Строительство, ремонт, монтаж",
  },
  {
    id: "transport",
    ...
    color: "blue",
    classIds: [38, 39, 40],
    hint: "Телеком, перевозки, обработка материалов",
  },
  {
    id: "education",
  ...
  },
  {
    ...
    color: "amber",
    classIds: [43, 44, 45],
    hint: "Общепит, медицина/красота, юр./охранные услуги",
  },
];
